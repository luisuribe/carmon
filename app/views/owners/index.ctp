<div class="owners index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $owner['Owner']['firstname']; ?>&nbsp;</td>
		<td><?php echo $owner['Owner']['lastname']; ?>&nbsp;</td>
		<td><?php echo $owner['Owner']['phone']; ?>&nbsp;</td>
		<td><?php echo $owner['Owner']['cellphone']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $owner['Owner']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $owner['Owner']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $owner['Owner']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $owner['Owner']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
